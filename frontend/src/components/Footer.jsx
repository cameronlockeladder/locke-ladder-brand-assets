      ...
      <div className="max-w-[1600px] mx-auto grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
        <div className="md:col-span-5">
          <div className="flex items-center gap-4">
            <span className="font-brand text-xl tracking-[0.08em] uppercase text-paper">Locke &amp; Ladder</span>
          </div>
          <p className="mt-6 text-sm leading-relaxed max-w-md text-paper/60">
            A Chicagoland exterior company started by an art student.
            Roofing, siding, windows &amp; doors, and gutters &mdash; with a standard for beauty
        ...
        <div className="md:col-span-4">
          ...
          <div className="mt-3 font-serif text-lg text-paper">Jon Strand</div>
        ...
        <div className="md:col-span-12 pt-8 mt-8 border-t border-paper/15 flex flex-col sm:flex-row justify-between gap-4 font-brand text-[11px] uppercase tracking-[0.2em] text-paper/45">
          ...
          <span>Proposal v4 &nbsp;&middot;&nbsp; Confidential</span>
        </div>
      </div>
    </footer>
  );
