  ...
  return (
    ...
    >
      <div className="max-w-[1600px] mx-auto">
        <SectionTag number="01 / 07" title="Priority One &mdash; The Sanctuary Leak" />
        ...
        <div className="mt-10 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
          <div className="lg:col-span-5 lg:sticky lg:top-28 self-start fade-in">
            <h2 className="font-serif font-light display-tight text-[9vw] sm:text-6xl lg:text-[5.2vw] leading-[1]">
              The roof is at the end of
              <span className="italic"> a long life.</span>
            </h2>
            <p className="mt-8 max-w-md text-body text-base leading-relaxed">
              ...
              What matters is what is happening underneath it &mdash; and that
              layer has been compromised for a while now.
            </p>

            <div className="mt-10 grid grid-cols-2 gap-4 max-w-md">
              <Stat value="30+" label="years on the roof" />
              <Stat value="N.E." label="steeple &mdash; primary ingress" />
          ...
          <div className="lg:col-span-7 space-y-10">
            ...
            <Annotated
              ...
              description="Shake loss, exposed fasteners, inconsistent coursing. The field is tired &mdash; not just at the leak."
            ...
            <figure className="fade-in group" data-testid="diagnosis-rot">
              <div className="relative overflow-hidden bg-ink/5 aspect-[16/10]">
                ...
                <div className="absolute top-5 left-5 flex items-center gap-3">
                  <span className="bg-paper text-ink px-2.5 py-1 font-serif text-xs italic">C</span>
                </div>
              </div>
              <figcaption className="mt-4 flex flex-col sm:flex-row gap-3 sm:gap-10">
                <div className="sm:w-56 shrink-0">
                  <div className="font-serif text-ink text-lg leading-snug">
                ...
                <p className="text-sm text-body leading-relaxed max-w-2xl">
                  ...
                  The new shakes sit bright and raw next to weathered wood &mdash;
                  and they stay that way for years. For a building the town
        ...
        <div className="mt-28 md:mt-36 grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          <div className="lg:col-span-12">
            <SectionTag number="&mdash;" title="Repair vs. Replace, plainly" className="mb-10" />
            <div className="grid grid-cols-1 md:grid-cols-2 gap-0 border border-rule">
              ...
              <Ledger
                ...
                notes={[
                  ...
                  "Resets the roof&rsquo;s clock &mdash; decades, not years.",
